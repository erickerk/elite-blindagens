/**
 * API Endpoint Seguro para Upload do Manual de Garantia Elite Track
...
const FILE_PATH = 'Manual-Digital-de-Seguranca-e-Garantia.pdf';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Sucesso
    console.log('[Elite Track API] Upload realizado com sucesso:', data);
